...
export default function Navbar() {
    return (
        <Disclosure as="nav" className="bg-transparent shadow-md w-full mt-6">
            {({ open }) => (
                <>
                    <div className="max-w-6xl  mx-auto px-2 sm:px-6 lg:px-8">
                        <div className="relative flex items-center justify-between h-16">
                            <div className="absolute inset-y-0 left-0 flex items-center sm:hidden">
                                {/* Mobile menu button*/}
                                <Disclosure.Button className="inline-flex items-center justify-center p-2 rounded-md text-slate-700 hover:text-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white">
                                            ...
                                            <a
                                                ...
                                                className={classNames(
                                                    item.current
                                                        ...
                                                        : 'text-slate-800 dark:text-slate-300 hover:bg-gray-700 hover:text-white',
